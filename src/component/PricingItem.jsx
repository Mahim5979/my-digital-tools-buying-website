...
const PricingItem = ({ plans }) => {
  ...
  return (
    <div
      className={` border-2 relative cursor-pointer h-full flex flex-col bg-base-200 p-6 rounded-2xl shadow-2xl space-y-2 hover:scale-105 duration-300 ${popular ? 'bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-white' : 'bg-white text-gray-800'}`}
    >
      <div
      ...
      <button
        ...
        className={`w-full mt-auto cursor-pointer py-2 rounded-lg font-bold ${
          popular
            ...
            : 'bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-white'
