      ...
      <div className="bg-base-300 p-6 rounded-xl shadow-md">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            disabled={checkout}
            className="px-6 py-3 cursor-pointer bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-white rounded-full font-semibold hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
          >
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="px-8 py-3 cursor-pointer bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-white rounded-full font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    Continue Shopping
                  </button>
                </div>
