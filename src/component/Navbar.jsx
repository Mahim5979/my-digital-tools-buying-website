...
const Navbar = ({ cart, darkMode, setDarkMode }) => {
  ...
  return (
    <div>
      <header
        className={`fixed z-50 w-full shadow-2xs py-2 ${darkMode ? 'bg-black/80 text-white' : 'bg-base-200'}`}
      >
        <nav className="  w-10/12 mx-auto flex items-center justify-between">
          <h1 className="text-lg sm:text-2xl md:text-4xl font-bold bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-transparent bg-clip-text cursor-pointer">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-4">
              ...
              <button className="px-4 py-2 text-sm sm:text-base cursor-pointer font-semibold border border-[#4F39F6] text-white bg-linear-to-r from-[#7026ED] to-[#A22DFF] rounded-full">
                Get Started
              </button>
            </div>
