        ...
        <div className=" p-8 text-center">
          ...
          <div className="grid grid-cols-1 mt-6 md:grid-cols-3 gap-6 pb-10">
            <div className=" relative  text-center space-y-2 bg-white p-6 rounded-lg shadow-lg h-96 items-center justify-center flex flex-col">
              <div className=" absolute text-white  top-2 right-6 w-8 h-8 rounded-full bg-linear-to-r from-[#7026ED] to-[#A22DFF] flex items-center justify-center mx-auto cursor-pointer hover:scale-110 duration-300">
