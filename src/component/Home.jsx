        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center items-center text-center lg:text-left lg:items-start space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
              <button className="px-6 py-3  cursor-pointer bg-linear-to-r from-[#7026ED] to-[#A22DFF] text-white rounded-full font-semibold hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl">
                Explore Products
              </button>
